...
export function buildNarrativePrompt(brief: NarrativeBrief): NarrativePrompt {
  ...
  const user = [
    ...
    '      "prose": "<dein Fließtext, Deutsch, 90-160 Wörter>",',
    ...
    '',
    '=== 7. SELBSTPRÜFUNG VOR DEM ABSENDEN ===',
    'Gehe deinen Text einmal Wort für Wort durch und prüfe:',
    '  a) Steht irgendwo ein Chart-Begriff, den DIESER Abschnitt nicht zitiert hat? -> streichen.',
    '  b) Steht irgendwo eine Ziffer, die kein zitierter value ist? -> streichen.',
    '  c) Steht neben jedem Chart-Begriff das richtige Rollenwort (oder gar keines)? -> korrigieren.',
    '  d) Nennt jeder Abschnitt mindestens einen seiner zitierten Begriffe? -> ergänzen.',
    '  e) Gibt es einen Abschnitt mit Verbindungswort und zwei verschiedenen Rollen? -> sonst ergänzen.',
    '  f) Steht irgendwo ein verbotener Methodenbegriff oder ein Schicksals-, Medizin-,',
    '     Rechts- oder Finanzsatz? -> streichen.',
