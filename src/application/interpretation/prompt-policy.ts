...
export function buildNarrativePrompt(brief: NarrativeBrief): NarrativePrompt {
  ...
  const user = [
    ...
    '',
    'R7 VERANKERUNG: Jeder "prose" MUSS mindestens ZWEI seiner zitierten Chart-Begriffe',
    '   wörtlich nennen. Ein Absatz, der weniger als zwei davon nennt, ist eine Vorlage,',
    '   in die ein einzelner Wert eingesetzt wurde, und wird verworfen.',
    '',
